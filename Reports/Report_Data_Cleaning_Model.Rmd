...
$$ y_i|x_i {\hspace 1mm}{\sim} {\hspace 1mm} Bernoulli (\pi_i); i = 1,2,\ldots, 13162; j = 1,2, \ldots, 25 $$ 
\begin{equation}
log(\frac{\pi_i}{1-\pi_i}) = (\beta_0 + \gamma_{0j|i|}) +  \beta_1 * age_{i1} + \beta_2*race\_code_{i2} + \beta_3*ethnic\_code_{i3} + \beta_4 sex\_code_{i4} + \beta_5 age:party\_cd_{i5} + \beta_6 sex\_code:party\_cd_{i6} + (\beta_7 + \gamma_{1j|i|}) party\_cd_{i7}
\end{equation}
